...
\begin{multicols}{2}
  ...
  \cvitem{Name}{Mohammed A R Quadri}
  \cvitem{Date of Birth}{\emph{May 24th, 1989}}
  \cvitem{Address}{Railway Wagon Work Shop Colony, Block No: 85/C, Guntupalli,}
  \cvitem{}{Vijayawada,521241}
  \cvitem{Mobile}{+9985933747}
  \cvitem{Email}{ataullah.quadri@gmail.com}
  \columnbreak
  \includegraphics[width=27mm, right]{../Downloads/ataullah}
\end{multicols}
%[width=27mm, right]
...
\cvitem{July 2012}{\textbf{K L Deemed to be University} 
\textit{Vaddeswaram, Guntur-522502, Andhra Pradesh, India} \newline Master of Technology \textbf{(M.Tech)} in Computer Networks \& Security
\newline with 9.01 CGPA, awarded First
Class with Distinction and Gold Medal for highest CGPA}

\cvitem{July 2010}{\textbf{Jawaharlal Nehru Technological University} 
\textit{Kakinada-533003,Andhra Pradesh, India} \newline Bachelor of Technology \textbf{(B.Tech)} in Computer Science \& Engineering
\newline with 73.4\% and awarded First Class with
Distinction}
