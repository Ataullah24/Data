...
\profilepic{../Downloads/ataullah.jpg}[width=50mm] % Profile picture

\cvname{Mohammed A R Quadri} % Your name
\cvjobtitle{Devops Engineer} % Job title/career

\cvdate{24 May 1989} % Date of birth
\cvaddress{ Rly Wagon Work Shop Colony, BlockNo:85C,Guntupalli,Andhra Pradesh, India-521241} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+91 9985933747} % Phone number
\cvsite{http://en.wikipedia.org} % Personal website
\cvmail{ataullah.quadri@gmail.com} % Email address
